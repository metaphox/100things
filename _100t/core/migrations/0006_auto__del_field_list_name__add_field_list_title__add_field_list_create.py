...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_list', 'name')

        # Adding field 'List.title'
        db.add_column(u'core_list', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'List.created'
        db.add_column(u'core_list', 'created',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_list', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Deleting field 'List.title'
        db.delete_column(u'core_list', 'title')

        # Deleting field 'List.created'
        db.delete_column(u'core_list', 'created')
