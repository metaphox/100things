...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field item_category on 'ListItem'
        m2m_table_name = db.shorten_name(u'core_listitem_item_category')
        ...
        db.delete_table(db.shorten_name(u'core_list_items'))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field item_category on 'ListItem'
        db.delete_table(db.shorten_name(u'core_listitem_item_category'))

        # Adding M2M table for field items on 'List'
        m2m_table_name = db.shorten_name(u'core_list_items')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('list', models.ForeignKey(orm[u'core.list'], null=False)),
            ('item', models.ForeignKey(orm[u'core.item'], null=False))
        ))
        db.create_unique(m2m_table_name, ['list_id', 'item_id'])
    ...
    models = {
        ...
        u'core.listitem': {
            'Meta': {'unique_together': "(('item_list', 'item', 'item_index'),)", 'object_name': 'ListItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Item']"}),
            'item_category': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Category']", 'symmetrical': 'False'}),
