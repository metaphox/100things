...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_item', 'index')

        # Deleting field 'Item.sub_index'
        db.delete_column(u'core_item', 'sub_index')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_item', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.sub_index'
        db.add_column(u'core_item', 'sub_index',
    ...
    models = {
        ...
        u'core.list': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Item']", 'symmetrical': 'False'}),
